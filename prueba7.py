...
def prueba_ANOVA():
    ...
    data = st.text_input("Ingresa los datos de la muestra, -los datos de cada grupo separados por comas y los grupos separados por 'punto y coma'- (ej. 1, 2, 3; 4, 5, 6; 7, 8, 9): ", value="1, 2, 3; 4, 5, 6; 7, 8, 9")
